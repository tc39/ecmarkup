...
const out = '<!doctype html>\n<head><meta charset="utf-8"></head><body><div id="spec-container"><emu-clause id="sec"><h1 class="first"><span class="secnum">1</span>hi<span class="utils"><span class="anchor"><a href="#sec">link</a></span><span class="anchor"><a href="#" class="utils-pin">pin</a></span></span></h1></emu-clause></div></body>';
function fetch(file) {
  if (file.match(/\.json$/)) {
    return '{}';
  } else {
