...
const out =
  '<!doctype html>\n<head><meta charset="utf-8"><script type="application/json" id="sdo-map">{}</script></head><body><div id="spec-container"><emu-clause id="sec"><h1><span class="secnum">1</span> hi</h1></emu-clause></div></body>';
